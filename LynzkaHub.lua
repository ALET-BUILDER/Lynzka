...
MainFrame.BackgroundColor3 = Color3.fromRGB(14, 10, 24)
...
MainStroke.Color = Color3.fromRGB(180, 80, 200)
...
TT.TextColor3 = Color3.fromRGB(220, 160, 255)
...
SubTitle.Text = "Panel Admin: #fyp #robloxfyp #scripture"
SubTitle.Size = UDim2.new(1, -120, 0, 16)
SubTitle.Position = UDim2.new(0, 14, 0, 28)
SubTitle.BackgroundTransparency = 1
SubTitle.TextColor3 = Color3.fromRGB(140, 110, 170)
...
SidePanel.Size = UDim2.new(0, 150, 1, -52)
SidePanel.Position = UDim2.new(0, 0, 0, 50)
SidePanel.BackgroundColor3 = Color3.fromRGB(20, 14, 32)
SidePanel.BackgroundTransparency = 0
SidePanel.BorderSizePixel = 0
SidePanel.Parent = MainFrame
Instance.new("UICorner", SidePanel).CornerRadius = UDim.new(0, 0)

local SideList = Instance.new("UIListLayout", SidePanel)
SideList.SortOrder = Enum.SortOrder.LayoutOrder
SideList.Padding = UDim.new(0, 4)

local SidePadding = Instance.new("UIPadding", SidePanel)
...
ContentPanel.Size = UDim2.new(1, -162, 1, -52)
ContentPanel.Position = UDim2.new(0, 154, 0, 50)
ContentPanel.BackgroundColor3 = Color3.fromRGB(10, 8, 20)
ContentPanel.BackgroundTransparency = 0
ContentPanel.BorderSizePixel = 0
ContentPanel.ClipsDescendants = true
ContentPanel.Parent = MainFrame
Instance.new("UICorner", ContentPanel).CornerRadius = UDim.new(0, 0)
...
local function createTab(name, icon, order)
    ...
    btn.BackgroundColor3 = Color3.fromRGB(30, 22, 46)
    ...
    bl.TextColor3 = Color3.fromRGB(170, 150, 200)
    ...
    pg.ScrollBarImageColor3 = Color3.fromRGB(180, 80, 200)
    ...
    btn.MouseButton1Click:Connect(function()
        for n, t in pairs(tabs) do
            t.btn.BackgroundColor3 = Color3.fromRGB(30, 22, 46)
            t.label.TextColor3 = Color3.fromRGB(170, 150, 200)
            pages[n].Visible = false
        end
        btn.BackgroundColor3 = Color3.fromRGB(180, 80, 200)
...
local function createSection(p, text)
    ...
    l.BackgroundColor3 = Color3.fromRGB(180, 80, 200)
    l.BackgroundTransparency = 0.75
    l.BorderSizePixel = 0
    l.Text = "  " .. text
    l.TextColor3 = Color3.fromRGB(220, 160, 255)
...
local function createToggle(p, text, def, cb)
    ...
    fr.BackgroundColor3 = Color3.fromRGB(24, 18, 38)
    ...
    tr.BackgroundColor3 = st and Color3.fromRGB(180, 80, 200) or Color3.fromRGB(55, 55, 75)
    ...
    bt.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(tr, TweenInfo.new(0.2), {
            BackgroundColor3 = st and Color3.fromRGB(180, 80, 200) or Color3.fromRGB(55, 55, 75)
        }):Play()
...
local function createSlider(p, text, mn, mx, def, cb)
    ...
    bg.BackgroundColor3 = Color3.fromRGB(40, 30, 60)
    ...
    fl.BackgroundColor3 = Color3.fromRGB(180, 80, 200)
...
local function createButton(p, text, cb)
    ...
    bt.BackgroundColor3 = Color3.fromRGB(24, 18, 38)
    ...
    bt.MouseButton1Click:Connect(function()
        TweenService:Create(bt, TweenInfo.new(0.08), {
            BackgroundColor3 = Color3.fromRGB(180, 80, 200)
        }):Play()
    ...
    if not isNotifying then
        ...
        task.spawn(function()
            while #notificationQueue > 0 do
                ...
                n.BackgroundColor3 = Color3.fromRGB(24, 18, 38)
                n.BackgroundTransparency = 0
                n.TextColor3 = Color3.fromRGB(200, 160, 255)
                n.Font = Enum.Font.GothamBold
                n.TextSize = 14
                n.Text = notif.text
                n.Parent = ScreenGui
                Instance.new("UICorner", n).CornerRadius = UDim.new(0, 8)
                Instance.new("UIStroke", n).Color = Color3.fromRGB(180, 80, 200)
                Instance.new("UIStroke", n).Transparency = 0.5
...
local function buildUI()
    ...
    createSection(playerPage, "Wallbang")
    ...
    -- Visual Tab
    local visualPage = createTab("Visual", "👁️", 2)
    ...
    createSection(visualPage, "Tracer")
    ...
    -- Combat Tab
    local combatPage = createTab("Combat", "⚔️", 3)
    ...
    hitboxFrame.BackgroundColor3 = Color3.fromRGB(24, 18, 38)
    ...
    hitboxButtons["Head"].BackgroundColor3 = Color3.fromRGB(180, 80, 200)
    ...
    plCount.BackgroundColor3 = Color3.fromRGB(20, 14, 32)
    ...
    infoScroll.ScrollBarImageColor3 = Color3.fromRGB(180, 80, 200)
...
=========================================
    ...
    -- Misc Tab
    local miscPage = createTab("Misc", "⚙️", 6)
        ...
        for _, page in pairs(pages) do
            for _, child in pairs(page:GetChildren()) do
                if child:IsA("TextLabel") and child.BackgroundColor3 and child.BackgroundTransparency ~= 1 then
                    if child.BackgroundColor3.R == 180 and child.BackgroundColor3.G == 80 and child.BackgroundColor3.B == 200 then
                        child.BackgroundColor3 = Color3.fromRGB(
                            math.floor(180 + color.R * 75),
                            math.floor(80 + color.G * 120),
                            math.floor(200 + color.B * 55)
                        )
                    end
                end
            end
    ...
    createSlider(settingsPage, "Menu Width", 400, 800, 620, function(v)
    ...
    -- Health Bar Thickness dengan Preview
    local thicknessFrame = Instance.new("Frame", settingsPage)
    thicknessFrame.Size = UDim2.new(1, -4, 0, 70)
    thicknessFrame.BackgroundColor3 = Color3.fromRGB(24, 18, 38)
    ...
    previewFrame.BackgroundColor3 = Color3.fromRGB(40, 30, 60)
...
-- ========== FIRST TAB ==========
tabs["Player"].btn.BackgroundColor3 = Color3.fromRGB(180, 80, 200)
tabs["Player"].btn.BackgroundTransparency = 0.3
...
MinBtn.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(MainFrame, TweenInfo.new(0.3, Enum.EasingStyle.Back), {
        Size = minimized and UDim2.new(0, MainFrame.Size.X.Offset, 0, 48) or UDim2.new(0, MainFrame.Size.X.Offset, 0, sliderValues["Menu Height"] or 460)
    }):Play()
end)
